class RenderSide<T extends string | RenderMesh> {
    ...
    constructor(dir: string, public model: T, public importParams: RenderMesh.ImportParams = null
    ) {
    ...
    public getForTile(tileEntity: TileEntity.TileEntityPrototype): RenderMesh {
